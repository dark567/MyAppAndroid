...
import com.dark.new_test_job.alarm.Alarm.Difficulty;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String Sys_TABLE = "System";
	...
	public static final String COLUMN_ALARM_OWN = "alarm_own";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_REPEAT, alarm.getalarmRepeate());
		cv.put(COLUMN_ALARM_OWN, alarm.getAlarmOWN());
		cv.put(COLUMN_id_s, alarm.getAlarm_id_s());
	...
	public static Alarm getAlarm(int id) {
		...
		if(c.moveToFirst()){
			...
			alarm.setAlarmOWN(c.getString(9));
			alarm.setAlarm_id_s(c.getString(10));
		}
		c.close();
		return alarm;
	}
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( " 
				...
				+ COLUMN_ALARM_OWN + " TEXT, "
		        + COLUMN_id_s + " TEXT NOT NULL)");

//		db.execSQL("CREATE TABLE IF NOT EXISTS " + Sys_TABLE + " ( "
//				+ COLUMN_ALARM_ID + " INTEGER primary key autoincrement, "
//				+ COLUMN_ALARM_ACTIVE + " INTEGER NOT NULL, "
//				+ COLUMN_ALARM_TIME + " TEXT NOT NULL, "
//				+ COLUMN_ALARM_DAYS + " BLOB NOT NULL, "
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				alarm.setalarmRepeate(cursor.getInt(8)==1);
				alarm.setAlarmOWN(cursor.getString(9));
				alarm.setAlarm_id_s(cursor.getString(10));
