...
public class prmja_com {
    public static String Get(String s ,String[] a) throws ExecutionException, InterruptedException {
       ...
       // return new DownloadWebpageTask().execute(s,"GET",parameters).get();
    ...
    public static String Post(String s ,String[] a) throws ExecutionException, InterruptedException {
        ...
        //return new DownloadWebpageTask().execute(s+"test?","POST",parameters).get();
...
// params comes from the execute() call: params[0] is the url.
            try {
                ...
                Log.d("not access", urls[0]+urls[1]+urls[2]);
                Log.d("not access", e.toString());
                return "Не удалось получить веб-страницы. URL может быть недоступным.";
